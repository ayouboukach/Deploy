...
import { addAuthToken, addAuthUser } from "redux/features/auth/authSlice";
import { AuthenticationContext } from "context/authenticationContext";
import { refreshAccessToken_V2 } from "api";

let cmpntInitialized = false;
let componentIsMounted = false;

function PrivateRouteGuard({ component: Component, ...rest }){
