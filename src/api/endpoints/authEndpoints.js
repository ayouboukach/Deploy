...
/**
 * refreshAccessToken_V2 API endpoint
 * @param {object} data - Account Credentials
 * @param {string} data.refreshToken - The refresh token is required 
 * @returns {Promise} - Axios promise object
 */
export const refreshAccessToken_V2 = (data) =>
  http.post("/reauth", data, { withCredentials: false });
